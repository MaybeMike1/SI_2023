...
class Program
{
    ...
    {
        string jsonPath = "./Data/Me.json";
        string xmlPath = "./Data/Me.xml";
        string yamlPath = "./Data/Me.yaml";
        string textPath = "./Data/Me.txt";
        string csvPath = "./Data/Me.csv";



        fileSelector(xmlPath);
        fileSelector(yamlPath);
        fileSelector(textPath);
        fileSelector(csvPath);
        fileSelector(jsonPath);
